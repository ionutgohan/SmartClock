...
***********************************************************************************************************************/
  ...
  #include "TSS_Sensor.h"
    ...
    typedef INT16 (* TSS_CTS_FNC) (INT8 i8CTS_arg);
    ...
    typedef struct {
      ...
      const TSS_CTS_FNC cts_cps16CTSLowRoutine; 
      #if TSS_USE_NOISE_AMPLITUDE_FILTER
        const INT8 cts_i8AmplitudeFilterDeltaLimit;
      #endif
    } TSS_CTS_ELECTRODE_ROMDATA;
  ...
  *******************************************************************************/
  ...
  #define ExISR_ENABLED   0//1     /* default is 1, ex-post ISR detection */
  #define CTS_ASM_LOOPS   0     /* default is 1, asm code keep constant execution bus-cycles */
