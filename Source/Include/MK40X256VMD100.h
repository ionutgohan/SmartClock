...
typedef enum IRQn
{
  ...
  DMA9_IRQn                     =  12,      /*!< DMA Channel 9 Transfer Complete */
  DMA10_IRQn                    =  14,      /*!< DMA Channel 10 Transfer Complete */
  DMA11_IRQn                    =  15,      /*!< DMA Channel 11 Transfer Complete */
  DMA12_IRQn                    =  16,      /*!< DMA Channel 12 Transfer Complete */
  DMA13_IRQn                    =  17,      /*!< DMA Channel 13 Transfer Complete */
  DMA14_IRQn                    =  18,      /*!< DMA Channel 14 Transfer Complete */
  DMA15_IRQn                    =  19,      /*!< DMA Channel 15 Transfer Complete */
  DMA_Error_IRQn                =  20,      /*!< DMA Error Interrupt */
  MCM_IRQn                      =  21,      /*!< Normal Interrupt */
  FTFL_IRQn                     =  22,      /*!< FTFL Interrupt */
  Read_Collision_IRQn           =  23,      /*!< Read Collision Interrupt */
  LVD_LVW_IRQn                  =  24,      /*!< Low Voltage Detect, Low Voltage Warning */
  LLW_IRQn                      =  25,      /*!< Low Leakage Wakeup */
  Watchdog_IRQn                 =  26,      /*!< WDOG Interrupt */
  Reserved39_IRQn               =  27,      /*!< Reserved interrupt 39 */
  I2C0_IRQn                     =  28,      /*!< I2C0 interrupt */
  I2C1_IRQn                     =  29,      /*!< I2C1 interrupt */
  SPI0_IRQn                     =  30,      /*!< SPI0 Interrupt */
  SPI1_IRQn                     =  31,      /*!< SPI1 Interrupt */
  SPI2_IRQn                     =  32,      /*!< SPI2 Interrupt */
  CAN0_ORed_Message_buffer_IRQn =  33,      /*!< CAN0 OR'd Message Buffers Interrupt */
  CAN0_Bus_Off_IRQn             =  34,      /*!< CAN0 Bus Off Interrupt */
  CAN0_Error_IRQn               =  35,      /*!< CAN0 Error Interrupt */
  CAN0_Tx_Warning_IRQn          =  36,      /*!< CAN0 Tx Warning Interrupt */
  CAN0_Rx_Warning_IRQn          =  37,      /*!< CAN0 Rx Warning Interrupt */
  CAN0_Wake_Up_IRQn             =  38,      /*!< CAN0 Wake Up Interrupt */
  Reserved51_IRQn               =  39,      /*!< Reserved interrupt 51 */
  Reserved52_IRQn               =  40,      /*!< Reserved interrupt 52 */
  CAN1_ORed_Message_buffer_IRQn =  41,      /*!< CAN1 OR'd Message Buffers Interrupt */
  CAN1_Bus_Off_IRQn             =  42,      /*!< CAN1 Bus Off Interrupt */
  CAN1_Error_IRQn               =  43,      /*!< CAN1 Error Interrupt */
  CAN1_Tx_Warning_IRQn          =  44,      /*!< CAN1 Tx Warning Interrupt */
  CAN1_Rx_Warning_IRQn          =  45,      /*!< CAN1 Rx Warning Interrupt */
  CAN1_Wake_Up_IRQn             =  46,      /*!< CAN1 Wake Up Interrupt */
  Reserved59_IRQn               =  47,      /*!< Reserved interrupt 59 */
  Reserved60_IRQn               =  48,      /*!< Reserved interrupt 60 */
  UART0_RX_TX_IRQn              =  49,      /*!< UART0 Receive/Transmit interrupt */
  UART0_ERR_IRQn                =  50,      /*!< UART0 Error interrupt */
  UART1_RX_TX_IRQn              =  51,      /*!< UART1 Receive/Transmit interrupt */
  UART1_ERR_IRQn                =  52,      /*!< UART1 Error interrupt */
  UART2_RX_TX_IRQn              =  53,      /*!< UART2 Receive/Transmit interrupt */
  UART2_ERR_IRQn                =  54,      /*!< UART2 Error interrupt */
  UART3_RX_TX_IRQn              =  55,      /*!< UART3 Receive/Transmit interrupt */
  UART3_ERR_IRQn                =  56,      /*!< UART3 Error interrupt */
  UART4_RX_TX_IRQn              =  57,      /*!< UART4 Receive/Transmit interrupt */
  UART4_ERR_IRQn                =  58,      /*!< UART4 Error interrupt */
  UART5_RX_TX_IRQn              =  59,      /*!< UART5 Receive/Transmit interrupt */
  UART5_ERR_IRQn                =  60,      /*!< UART5 Error interrupt */
  ADC0_IRQn                     =  61,      /*!< ADC0 interrupt */
  ADC1_IRQn                     =  62,      /*!< ADC1 interrupt */
  CMP0_IRQn                     =  63,      /*!< CMP0 interrupt */
  CMP1_IRQn                     =  64,      /*!< CMP1 interrupt */
  CMP2_IRQn                     =  65,      /*!< CMP2 interrupt */
  FTM0_IRQn                     =  66,      /*!< FTM0 fault, overflow and channels interrupt */
  FTM1_IRQn                     =  67,      /*!< FTM1 fault, overflow and channels interrupt */
  FTM2_IRQn                     =  68,      /*!< FTM2 fault, overflow and channels interrupt */
  CMT_IRQn                      =  69,      /*!< CMT interrupt */
  RTC_IRQn                      =  70,      /*!< RTC interrupt */
  Reserved83_IRQn               =  71,      /*!< Reserved interrupt 83 */
  PIT0_IRQn                     =  76,      /*!< PIT timer channel 0 interrupt */
  PIT1_IRQn                     =  77,      /*!< PIT timer channel 1 interrupt */
  PIT2_IRQn                     =  78,      /*!< PIT timer channel 2 interrupt */
  PIT3_IRQn                     =  79,      /*!< PIT timer channel 3 interrupt */
  PDB0_IRQn                     =  80,      /*!< PDB0 Interrupt */
  USB0_IRQn                     =  81,      /*!< USB0 interrupt */
  USBDCD_IRQn                   =  82,      /*!< USBDCD Interrupt */
  Reserved91_IRQn               =  83,      /*!< Reserved interrupt 91 */
  Reserved92_IRQn               =  84,      /*!< Reserved interrupt 92 */
  Reserved93_IRQn               =  85,      /*!< Reserved interrupt 93 */
  Reserved94_IRQn               =  86,      /*!< Reserved interrupt 94 */
  I2S0_IRQn                     =  87,      /*!< I2S0 Interrupt */
  SDHC_IRQn                     =  88,      /*!< SDHC Interrupt */
  DAC0_IRQn                     =  89,      /*!< DAC0 interrupt */
  DAC1_IRQn                     =  90,      /*!< DAC1 interrupt */
  TSI0_IRQn                     =  91,      /*!< TSI0 Interrupt */
  MCG_IRQn                      =  92,      /*!< MCG Interrupt */
  LPTimer_IRQn                  =  93,      /*!< LPTimer interrupt */
  LCD_IRQn                      =  94,      /*!< Segment LCD Interrupt */
  PORTA_IRQn                    =  95,      /*!< Port A interrupt */
  PORTB_IRQn                    =  96,      /*!< Port B interrupt */
  PORTC_IRQn                    =  97,      /*!< Port C interrupt */
  PORTD_IRQn                    =  98,      /*!< Port D interrupt */
  PORTE_IRQn                    =  99,      /*!< Port E interrupt */
  Reserved108_IRQn              = 100,      /*!< Reserved interrupt 108 */
  Reserved109_IRQn              = 101,      /*!< Reserved interrupt 109 */
  Reserved110_IRQn              = 102,      /*!< Reserved interrupt 110 */
  Reserved111_IRQn              = 104,      /*!< Reserved interrupt 111 */
  Reserved112_IRQn              = 105,      /*!< Reserved interrupt 112 */
  Reserved113_IRQn              = 106,      /*!< Reserved interrupt 113 */
  Reserved114_IRQn              = 107,      /*!< Reserved interrupt 114 */
  Reserved115_IRQn              = 108,      /*!< Reserved interrupt 115 */
  Reserved116_IRQn              = 110,       /*!< Reserved interrupt 116 */
  Reserved117_IRQn              = 111,       /*!< Reserved interrupt 117 */
  Reserved118_IRQn              = 112,       /*!< Reserved interrupt 118 */
  Reserved119_IRQn              = 113       /*!< Reserved interrupt 119 */
}IRQn_Type;
